...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center overflow-hidden px-8 pt-24 pb-20" aria-label="Introduction">
      {/* Background */}
      ...
      <div className="relative z-10 max-w-[1240px] mx-auto w-full">
        <div className="max-w-[680px]">
          ...
          <motion.div {...show(.36)} className="flex flex-wrap gap-3 mb-16">
            ...
            <a href={CV_LINK} target="_blank" rel="noopener noreferrer" className="btn-ghost">
              ↓ Download CV
            </a>
          </motion.div>
